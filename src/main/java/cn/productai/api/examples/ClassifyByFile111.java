 ...
 */
public class ClassifyByFile111 {

    public void run(IWebClient client, File file) {


        ClassifyByImageFileRequest request = new ClassifyByImageFileRequest(ServiceType.Classify, "_0000111");
...
*/
    ...
    public static void main(String [] args) {
        ...
        ClassifyByFile111 classifyByFile = new ClassifyByFile111();
        ...
        System.out.println("==>  时尚智能分析  <==");
        System.out.println("See https://api-doc.productai.cn/doc/pai.html#时尚智能分析 for details.\r\n");
        int index = 0;
        for(File f : files) {
